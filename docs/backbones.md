...
- **Wide Variety of Architectures:** Extensive collection covering CNNs (ResNet, ConvNeXt), Vision Transformers (ViT, Swin, SwinV2), and hybrid models (MaxViT, MobileViT).
