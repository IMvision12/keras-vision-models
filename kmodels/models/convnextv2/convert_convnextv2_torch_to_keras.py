...
from kmodels.models import convnextv2
...
model_configs: List[Dict[str, Union[type, str, List[int], int]]] = [
    # ConvNeXtV2Huge
    {
        "keras_cls": convnextv2.ConvNeXtV2Huge,
        "torch_name": "convnextv2_huge.fcmae_ft_in1k",
        "input_shape": [224, 224, 3],
        "num_classes": 1000,
    },
    {
        "keras_cls": convnextv2.ConvNeXtV2Huge,
        "torch_name": "convnextv2_huge.fcmae_ft_in22k_in1k_384",
        "input_shape": [384, 384, 3],
        "num_classes": 1000,
    },
    {
        "keras_cls": convnextv2.ConvNeXtV2Huge,
        "torch_name": "convnextv2_huge.fcmae_ft_in22k_in1k_512",
