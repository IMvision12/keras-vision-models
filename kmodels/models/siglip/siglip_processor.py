        ...
        if vocab_file is None:
            if multilingual:
                vocab_file_path = download_file(
                    "https://github.com/IMvision12/keras-models/releases/download/SigLIP/siglip_multilingual_vocab.model"
                )
            else:
                vocab_file_path = download_file(
                    "https://github.com/IMvision12/keras-models/releases/download/SigLIP/siglip_vocab.model"
                )
        else:
