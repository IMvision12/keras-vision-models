...
class TestSegFormerImageProcessor:
    ...
    def test_input_types(self, sample_image_array, sample_image_pil, sample_image_path):
        result_array = segformer.SegFormerImageProcessor(sample_image_array, return_tensor=False)
        result_pil = segformer.SegFormerImageProcessor(sample_image_pil, return_tensor=False)
        result_path = segformer.SegFormerImageProcessor(sample_image_path, return_tensor=False)
